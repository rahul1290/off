   <div class="content-wrapper">	
	<div class="content-header bg-light mb-3">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Roaster</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
		...
		<div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header" style="border-radius:0px;">
                <span class="card-title">Attendance Roaster</span>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" name="f1" method="POST" action="<?php echo base_url('ibc/hr/roster'); ?>" enctype="multipart/form-data">
                  <div class="row">
					  <div class="mr-2">
						<input type="file" name="userfile" class="form-control">
					  </div>
					  <input type="submit" name="userfile" value="submit" class="btn btn-secondary">
					  <span class="float-right">To download Sample file click <a href="#">Here</a></span>
				  </div>
                </form>
              </div>
              <!-- /.card-body -->
