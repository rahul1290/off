		...
		<div class="offset-md-1 col-md-10">
            <form name="f1" method="POST" action="<?php echo base_url('master/employee/update/'.$employee_detail[0]['ecode']); ?>">
				<div class="form-row mb-3" style="border: solid 1px #123456;">
					...
					<div class="form-group col-md-2">
						<label for="employee_code">Reporting To</label>
						<select name="repto" class="form-control" id="repto">
							<option value="0">Select Employee</option>
							<?php foreach($employees as $employee){ ?>
								<option value="<?php echo $employee['id']; ?>" <?php if($employee['id'] == set_value('repto')){ echo "selected"; } ?>><?php echo ucfirst($employee['name']); ?> - [[<?php echo $employee['ecode']; ?>]]</option>
							<?php } ?>
						</select>
					</div>
				</div>
